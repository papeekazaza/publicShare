...
public class Deposit extends Transaction
{
	...
	public void execute()
	{
		...
		if (amount != CANCELED)
		{
			...
			if (envelopeReceived)
			{
				screen.displayMessageLine("\nYour envelope has been"+"received.\nNOTE: The money just deposited will 1 not"+"be available until we verify the amount of any"+"enclosed cash and your checks clear.");
